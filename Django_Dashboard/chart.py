...
def chart_func():
	df = pd.read_csv('Django_Dashboard/datasets/appstore_games_march_2021.csv', low_memory=False)
	df = df.dropna()
	...
	fig = figure(x_axis_type='datetime',plot_height=650, plot_width=1350,title='Date vs App Price')
